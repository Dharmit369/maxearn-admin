...
const ModelDetailsNew = ({ setModelDetails, modelData }: any) => {
                ...
                <div className="w-96 rounded-lg bg-white p-8 shadow-lg dark:bg-[#29221C]">
                    ...
                    <div>
                        <div className="mb-6 flex">
                            ...
                            <div className="w-2/3">{modelData?.username}</div>
                        </div>
                        <div className="mb-6 flex">
                            <div className="font-bold w-1/2">Amount:</div>
                            <div className="w-2/3">{modelData?.amount}</div>
                        </div>
                        <div className="mb-6 flex">
                            <div className="font-bold w-1/2">status:</div>
                            <div className="w-2/3">{modelData?.status}</div>
                        </div>
                        <div className="mb-6 flex">
...
export default ModelDetailsNew;
