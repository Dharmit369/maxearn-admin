...
export default function Tds() {
    ...
    return loading ? (
        ...
        <div>
          <div className="flex flex-col lg:flex-row lg:gap-3 mb-6">
  <div className="flex flex-col w-full lg:w-1/2">
    <label htmlFor="from_date" className="mb-1">From Date</label>
    <input
      id="from_date"
      type="date"
      placeholder="from Date"
      className="form-input mt-1 h-10 dark:border-none dark:bg-[#1E1611] w-full"
      name="from_date"
  ...
  <div className="flex flex-col w-full lg:w-1/2 mt-4 lg:mt-0">
    <label htmlFor="to_date" className="mb-1">To Date</label>
    <input
      id="to_date"
      type="date"
      placeholder="to date"
