...
const AdsBanner = () => {
  ...
  const submitData = async () => {
    ...
    try {
      ...
      formData.append("status", banner?.url);
  ...
  const EditBanner = async (id: any) => {
    ...
    try {
      ...
      const res = await axios.put(
        `${BASE_URL}/admin/dashboardCard/${id}`,
        formData,
        {
          maxBodyLength: Infinity,
          headers: {
  ...
  const getBanner = async () => {
    ...
    try {
      const res = await axios.get(`${BASE_URL}/admin/dashboardCard`, {
        maxBodyLength: Infinity,
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const deleteBanner = async (id: any) => {
    ...
    try {
      const res = await axios.delete(`${BASE_URL}/admin/dashboardCard/${id}`, {
        maxBodyLength: Infinity,
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleEditClick = (banner: any) => {
    ...
    setEdit(true);
    setModel(true);
    setBanner({ file: banner?.file, url: banner?.status });
    setFiles(null);
    setUploadedFiles([]);
  };
