...
import animatedLoader from "../../public/Images/loader.json";
...
const signin = () => {
  ...
  const [toustString, setToustString] = useState("");
  const [loader, setLoader] = useState(false);
  const [username, setUsername] = useState("");
  const [show, setShow] = useState(false);
  const [email, setEmail] = useState("");
  const [emailError, setEmailError] = useState("");
  const [eyesShow, setEyesShow] = useState(false);
  ...
  const showAlert = async (type: number, success: string) => {
    if (type === 15) {
      const toast = Swal.mixin({
        toast: true,
        position: "top-end",
      ...
      toast.fire({
        icon: success == "Login Successfull." ? "success" : "error",
        title: success,
        padding: "10px 20px",
      });
    }
...
//           <div className="relative flex flex-col justify-center rounded-md bg-white/60 px-6 py-20 backdrop-blur-lg dark:bg-[#0f101E] lg:min-h-[500px] ">
...
//               />
//             </div>
//             <div className="top- absolute end-6">
...
//                     <div className="mb-5">
//                       <div className="flex">
//                         {/* <input type="text" placeholder="" className="form-input ltr:rounded-r-none rtl:rounded-l-none" /> */}
//                         <input
//                           value={password}
//                           onChange={handlePasswordChange}
//                           id="Password"
...
//                 {emailError && (
//                   <LabelComponent
//                     className="font-manrope flex items-center justify-center text-base text-red-500"
//                     label={emailError}
//                   />
//                 )}
//                 {passwordError && (
