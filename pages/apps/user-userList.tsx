...
export default function User({setEdit, getUserList, editId}) {
       ...
       <div className="p-10 rounded-lg ">
            <form className="space-y-6">
                <div>
                    ...
                    <input id="Name" type="text" placeholder="Enter Name" className="form-input w-full dark:bg-[#261C16] dark:border-none" name="username" onChange={(e) => handleChange(e)} value={userData?.username}/>
                </div>
                <div>
                    <label htmlFor="websiteName" className="block text-black mb-2 dark:text-white">Birth Date</label>
                    <input id="Name" type="date" placeholder="Birth Date" className="form-input w-full dark:bg-[#261C16] dark:border-none" name="birth_date" onChange={(e) => handleChange(e)} value={userData?.birth_date}/>
                </div>
                <div>
                    <label htmlFor="websiteName" className="block text-black mb-2 dark:text-white">State</label>
                    <input id="Name" type="text" placeholder="State" className="form-input w-full dark:bg-[#261C16] dark:border-none" name="state" onChange={(e) => handleChange(e)} value={userData?.state}/>
                </div>
                <div>
                    <label htmlFor="websiteName" className="block text-black mb-2 dark:text-white">pincode</label>
                    <input id="Name" type="text" placeholder="pincode" className="form-input w-full dark:bg-[#261C16] dark:border-none" name="pincode" onChange={(e) => handleChange(e)} value={userData?.pincode}/>
                </div>
                <div>
                    <label htmlFor="websiteName" className="block text-black mb-2 dark:text-white">socialMediaAccount</label>
                    <input id="Name" type="text" placeholder="socialMediaAccount" className="form-input w-full dark:bg-[#261C16] dark:border-none" name="socialMediaAccount" onChange={(e) => handleChange(e)} value={userData?.socialMediaAccount}/>
                </div>
                <div>
                    <label htmlFor="websiteName" className="block text-black mb-2 dark:text-white">password</label>
                    <input id="Name" type="text" placeholder="password" className="form-input w-full dark:bg-[#261C16] dark:border-none" name="password" onChange={(e) => handleChange(e)} value={userData?.password}/>
                </div>
                <div>
                    <label htmlFor="websiteName" className="block text-black mb-2 dark:text-white">isBlocked</label>
                    <input id="Name" type="text" placeholder="isBlocked" className="form-input w-full dark:bg-[#261C16] dark:border-none" name="isBlocked" onChange={(e) => handleChange(e)} value={userData?.isBlocked}/>
                </div>
                <div>
                    <label htmlFor="websiteName" className="block text-black mb-2 dark:text-white">referralActive</label>
                    <input id="Name" type="text" placeholder="referralActive" className="form-input w-full dark:bg-[#261C16] dark:border-none" name="referralActive" onChange={(e) => handleChange(e)} value={userData?.referralActive}/>
                </div>
